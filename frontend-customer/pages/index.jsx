		...
		<>
			...
			<main className='home-page'>
				...
				<Divider orientation='center' style={{
					borderColor:'black'
				}}>Danh sách tất cả sản phẩm</Divider>
            ...
            />
				...
				<div  className="d-none homepage-basic bg-dark text-light">
					<div className="d-flex">
				...
				<div className="d-none homepage-hagstag">
					<div className="row">
						<div className="col-6">
				...
				<div className="d-none homepage-service" >
					<div className="d-flex">
